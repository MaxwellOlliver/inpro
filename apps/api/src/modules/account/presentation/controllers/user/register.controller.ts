...
import { RegisterCommand } from '@modules/account/application/commands/user/register.command';
import { UserPresenter } from '../../presenters/user.presenter';
import { ProfilePresenter } from '@modules/profile/presentation/http/presenters/profile.presenter';
